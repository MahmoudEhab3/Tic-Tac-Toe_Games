...
public:
   // Return true  if move is valid and put it on b
   // within b boundaries in empty cell
   ...
   // Display the b and the pieces on it
...
///////////////////////////////////////////
// This class represents a 3 x 3 b
// used in X_O game
...
// a name and a symbol to put on b
class Player {
    protected:
        string name;
        char symbol;
...
class GameManager {
    ...
    public:
        ...
        void run();
        // This method creates b and players
        // It displays b
        // While True
        //   For each player
        //      It takes a valid move as x, y pair (between 0 - 2)
        //      It updates b and displays otit
